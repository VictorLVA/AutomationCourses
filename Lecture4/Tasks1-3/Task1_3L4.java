            ...
            while ((sCurrentLine = readVouchersFile.readLine()) != null) {
                ...
                try {
                    switch (Integer.parseInt(voucherDetails[0])) {
                        case 1:
                            Voucher restVoucher = new RestVoucher(voucherDetails);
                            listOfVouchers.add(restVoucher);
                            break;
                        case 2:
                            Voucher cureVoucher = new CureVoucher(voucherDetails);
                            listOfVouchers.add(cureVoucher);
                            break;
                        case 3:
                            Voucher shoppingVoucher = new ShoppingVoucher(voucherDetails);
